...
const CACHE = 'pimaestro-v14';
const SHELL = ['/', '/index.html', '/app.js', '/session.js', '/render.js', '/sound.js', '/sse.js', '/catalog.js', '/pilib.js', '/nav.js', '/transport.js', '/setup.js', '/vendor/webaudio-tinysynth.js',
